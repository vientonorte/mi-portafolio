import svgPaths from "./svg-gdqn4ibrlm";
...
import { imgGrowthLines } from "./svg-fv5w0";
  ...
  return (
    <div className="h-[48px] relative shrink-0 w-[147px]" data-name="SURA logo">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 147 48">
        <g id="SURA logo">
          <path d={svgPaths.p1482a000} fill="var(--fill-0, #161618)" id="wing" />
          <path clipRule="evenodd" d={svgPaths.p3cb65280} fill="var(--fill-0, #161618)" fillRule="evenodd" id="sura" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="mask-alpha mask-intersect mask-no-clip mask-no-repeat mask-position-[83px_-247px] mask-size-[434px_640px] relative size-full" data-name="Growth lines" style={{ maskImage: `url('${imgGrowthLines}')` }}>
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 563 423">
        <g id="Growth lines">
          ...
          <path d={svgPaths.p167fb100} fill="url(#paint0_linear_5_7830)" id="Vector_3" />
          <path d={svgPaths.p1d9cbf00} fill="var(--fill-0, #161618)" id="Vector_4" />
          <path d={svgPaths.p1f488080} fill="url(#paint1_linear_5_7830)" id="Vector_5" />
          <path d="M0 423L563 13.3079V0L0 423Z" fill="url(#paint2_linear_5_7830)" id="Vector_6" />
          <path d={svgPaths.p6590f00} fill="var(--fill-0, #0B2DCE)" id="Vector_7" />
          <path d={svgPaths.p201ffa00} fill="var(--fill-0, #FFE946)" id="Vector_8" />
        </g>
        <defs>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint0_linear_5_7830" x1="0" x2="563" y1="324.598" y2="324.598">
            <stop stopColor="#333333" />
            <stop offset="0.31" stopColor="#222222" />
            <stop offset="0.66" stopColor="#151515" />
            <stop offset="1" stopColor="#111111" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint1_linear_5_7830" x1="-18.7667" x2="-18.4539" y1="218.154" y2="218.154">
            <stop stopColor="#333333" />
            <stop offset="0.31" stopColor="#222222" />
            <stop offset="0.66" stopColor="#151515" />
            <stop offset="1" stopColor="#111111" />
          </linearGradient>
          <linearGradient gradientUnits="userSpaceOnUse" id="paint2_linear_5_7830" x1="0" x2="563" y1="211.5" y2="211.5">
