      ...
      unifiedBanner: {
        ...
        suggestions: [
          ...
          },
          {
            ...
            hint: 'CV, experiencia y trayectoria — reclutadores y campañas LinkedIn SEM.',
            badge: 'Perfil',
            keywords: ['perfil', 'cv', 'reclutadores', 'linkedin', 'experiencia', 'contacto', 'sem'],
            href: 'section/sobre-mi/experiencia',
          },
          {
            ...
            hint: 'Freemium con evidencia WCAG 2.2 AA — para negocios y leads.',
            badge: 'Auditoría UX',
      ...
      unifiedBanner: {
        ...
        suggestions: [
          ...
          },
          {
            id: 'contacto-perfil',
            category: 'contacto',
            title: 'Profile · UX Lead',
            hint: 'CV, experience, and track record — recruiters and LinkedIn SEM campaigns.',
            badge: 'Profile',
            keywords: ['profile', 'cv', 'recruiters', 'linkedin', 'experience', 'contact', 'sem'],
            href: 'section/sobre-mi/experiencia',
          },
          {
            id: 'auditoria-freemium',
            category: 'auditorias',
            title: 'Free UX audit',
            hint: 'Freemium with WCAG 2.2 AA evidence — for businesses and leads.',
            badge: 'UX Audit',
