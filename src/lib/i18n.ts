  ...
  es: {
    ...
    impactStats: {
      ...
      featured: {
        ...
        pathsLabel: 'Explora por ruta',
        paths: [
          {
            id: 'full-case',
            title: 'Caso completo RIA',
            hint: 'Contexto, proceso aplicado, mockups y aprendizajes del proyecto US.',
          ...
          {
            id: 'onboarding',
            title: 'Onboarding multi-perfil',
            hint: 'Asesores local/USA · perfiles, validaciones y compliance en flujo.',
            href: 'project/sura-ria-us',
          },
          {
            id: 'auth-flows',
            title: 'Flujos de autenticación',
            hint: '3 flujos regulatorios documentados con casos de error.',
            href: 'process/ux-ui-design',
          },
          {
            id: 'prototypes',
            title: '8 prototipos interactivos',
            hint: 'Prototipos navegables listos para handoff a desarrollo.',
            href: 'project/sura-ria-us',
          },
          {
            id: 'dashboard',
            title: 'Dashboard de inversiones',
            hint: 'Progressive disclosure y testing retail/institucional.',
            href: 'project/sura-inversiones-dashboard',
          },
          {
            id: 'ux-research',
            title: 'Fase UX Research',
            hint: 'Entrevistas y validación con stakeholders del mercado US.',
            href: 'process/ux-research',
          },
        ],
  ...
  en: {
    ...
    impactStats: {
      ...
      featured: {
        ...
        pathsLabel: 'Explore by path',
        paths: [
          {
            id: 'full-case',
            title: 'Full RIA case study',
            hint: 'Context, applied process, mockups, and learnings from the US project.',
            href: 'project/sura-ria-us',
            featured: true,
            badge: 'Main',
          },
          {
            id: 'onboarding',
            title: 'Multi-profile onboarding',
            hint: 'Local/US advisors · profiles, validations, and compliance in flow.',
            href: 'project/sura-ria-us',
          },
          {
            id: 'auth-flows',
            title: 'Authentication flows',
            hint: '3 regulatory flows documented with error states.',
            href: 'process/ux-ui-design',
          },
          {
            id: 'prototypes',
            title: '8 interactive prototypes',
            hint: 'Navigable prototypes ready for dev handoff.',
            href: 'project/sura-ria-us',
          },
          {
            id: 'dashboard',
            title: 'Investment dashboard',
            hint: 'Progressive disclosure and retail/institutional testing.',
            href: 'project/sura-inversiones-dashboard',
          },
          {
            id: 'ux-research',
            title: 'UX Research phase',
            hint: 'Interviews and validation with US market stakeholders.',
            href: 'process/ux-research',
          },
        ],
