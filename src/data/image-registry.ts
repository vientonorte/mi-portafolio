...
export const IMAGE_REGISTRY: ImageRegistryEntry[] = [
  ...
  entry("sura.hotjarDashboard", "SURA", "Hotjar", "sura/hotjar-dashboard.png", portfolioImages.sura.hotjarDashboard, "Dashboard Hotjar"),
  entry("sura.bookingFlowchart", "SURA", "Booking flowchart", "sura/booking-flowchart.png", portfolioImages.sura.bookingFlowchart, "Flujo de booking"),
