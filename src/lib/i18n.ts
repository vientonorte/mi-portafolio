  ...
  es: {
    ...
    impactStats: {
      ...
      featured: {
        ...
        pathsLabel: 'Un caso por camino',
        paths: [
          {
            id: 'reclutadores',
            title: 'Reclutadores',
            hint: 'Experiencia, CV y rol UX Lead — trayectoria en fintech regulado y mobility.',
            href: 'section/sobre-mi/experiencia',
            badge: 'Perfil',
          },
          {
            id: 'leads',
            title: 'Leads y negocios',
            hint: 'Caso RIA completo: onboarding US, auth regulatorio, prototipos y resultados medibles.',
            href: 'project/sura-ria-us',
            badge: 'Caso',
          },
          {
            id: 'auditoria',
            title: 'Auditoría freemium',
            hint: 'Flujos auth regulatorios documentados — evidencia para tu auditoría UX gratuita.',
    ...
    hero: {
      ...
      unifiedBanner: {
        ...
        searchPlaceholder: 'Buscar casos, contacto o auditoría…',
        ...
        suggestions: [
          {
            ...
            hint: 'SURA, Transvip y Karri con métricas en producción.',
            keywords: ['negocios', 'casos', 'sura', 'karri', 'transvip', 'proyectos', 'fintech'],
          ...
          },
          {
            ...
            category: 'negocios',
            title: 'RIA SURA Investments US',
            hint: 'Onboarding multi-perfil, auth regulatorio y prototipos US.',
            keywords: ['ria', 'onboarding', 'asesores', 'usa', 'inversiones', 'sura'],
            href: 'project/sura-ria-us',
          },
          {
            id: 'negocios-dashboard',
            category: 'negocios',
            title: 'Dashboard de inversiones',
            hint: 'NPS 72, progressive disclosure y testing retail/institucional.',
            keywords: ['dashboard', 'nps', 'inversiones', 'métricas', 'retail'],
            href: 'project/sura-inversiones-dashboard',
          },
          {
            id: 'negocios-autosuggest',
            category: 'negocios',
            title: 'Autosuggest de fondos',
            hint: 'Búsqueda predictiva con capas progresivas y compliance.',
            keywords: ['autosuggest', 'fondos', 'búsqueda', 'search', 'sura'],
            href: 'path/proyectos/autosuggest-fondos',
          },
          {
            id: 'contacto-form',
            category: 'contacto',
            title: 'Ir a contacto',
            hint: 'Formulario unificado — respuesta en menos de 24 h.',
            keywords: ['contacto', 'email', 'mensaje', 'hablar', 'conectar'],
            href: 'route/contacto',
          },
          {
            id: 'contacto-experiencia',
            category: 'contacto',
            title: 'Experiencia y CV',
            hint: 'Trayectoria UX Lead en fintech regulado y mobility.',
            keywords: ['cv', 'experiencia', 'reclutadores', 'perfil', 'trabajo'],
            href: 'section/sobre-mi/experiencia',
          },
          {
            id: 'contacto-perfil',
            category: 'contacto',
            title: 'Sobre mí',
            hint: 'Perfil completo, habilidades y contexto profesional.',
            keywords: ['sobre mí', 'perfil', 'bio', 'rodri', 'gaete'],
            href: 'route/sobre-mi',
          },
          {
            id: 'auditoria-gratis',
            ...
            hint: 'Freemium con checklist WCAG 2.2 AA y plan de mentoría.',
            keywords: ['auditoría', 'audit', 'gratis', 'freemium', 'wcag', 'accesibilidad'],
            href: 'route/auditoria',
          },
          {
            id: 'auditoria-consultoria',
            category: 'auditorias',
          ...
          {
            id: 'auditoria-proceso',
            category: 'auditorias',
            title: 'Flujos auth regulatorios',
            hint: '3 flujos documentados con casos de error — evidencia UX.',
            keywords: ['auth', 'regulatorio', 'compliance', 'flujos', 'proceso'],
            href: 'process/ux-ui-design',
          },
        ],
        panels: {
          negocios: {
  ...
  en: {
    ...
    impactStats: {
      ...
      featured: {
        ...
        pathsLabel: 'One case per journey',
        paths: [
          {
            id: 'reclutadores',
            title: 'Recruiters',
            hint: 'Experience, CV, and UX Lead role — track record in regulated fintech and mobility.',
            href: 'section/sobre-mi/experiencia',
            badge: 'Profile',
          },
          {
            id: 'leads',
            title: 'Leads and business',
            hint: 'Full RIA case: US onboarding, regulatory auth, prototypes, and measurable outcomes.',
            href: 'project/sura-ria-us',
            badge: 'Case',
          },
          {
            id: 'auditoria',
            title: 'Freemium audit',
            hint: 'Documented regulatory auth flows — evidence for your free UX audit.',
            href: 'route/auditoria',
            badge: 'Free',
          },
        ],
    ...
    hero: {
      ...
      unifiedBanner: {
        ...
        searchPlaceholder: 'Search cases, contact, or audit…',
        ...
        suggestions: [
          {
            ...
            hint: 'SURA, Transvip, and Karri with production metrics.',
            keywords: ['business', 'cases', 'sura', 'karri', 'transvip', 'projects', 'fintech'],
            href: 'route/proyectos',
          },
          {
            id: 'negocios-ria',
            category: 'negocios',
            title: 'RIA SURA Investments US',
            hint: 'Multi-profile onboarding, regulatory auth, and US prototypes.',
            keywords: ['ria', 'onboarding', 'advisors', 'usa', 'investments', 'sura'],
            href: 'project/sura-ria-us',
          },
          {
            id: 'negocios-dashboard',
            ...
            hint: 'NPS 72, progressive disclosure, retail/institutional testing.',
            keywords: ['dashboard', 'nps', 'investments', 'metrics', 'retail'],
            href: 'project/sura-inversiones-dashboard',
          },
          {
            id: 'negocios-autosuggest',
            category: 'negocios',
            title: 'Fund autosuggest',
            hint: 'Predictive search with progressive layers and compliance.',
            keywords: ['autosuggest', 'funds', 'search', 'sura'],
            href: 'path/proyectos/autosuggest-fondos',
          },
          {
            id: 'contacto-form',
            category: 'contacto',
            title: 'Go to contact',
            hint: 'Unified form — reply within 24 h.',
            keywords: ['contact', 'email', 'message', 'connect', 'reach'],
            href: 'route/contacto',
          },
          {
            id: 'contacto-experiencia',
            ...
            hint: 'UX Lead track record in regulated fintech and mobility.',
            keywords: ['cv', 'experience', 'recruiters', 'profile', 'hire'],
            href: 'section/sobre-mi/experiencia',
          },
          {
            id: 'contacto-perfil',
            category: 'contacto',
            title: 'About me',
            hint: 'Full profile, skills, and professional context.',
            keywords: ['about', 'profile', 'bio', 'rodrigo', 'gaete'],
            href: 'route/sobre-mi',
          },
          {
            id: 'auditoria-gratis',
            category: 'auditorias',
            title: 'Free UX audit',
            hint: 'Freemium with WCAG 2.2 AA checklist and mentoring plan.',
            keywords: ['audit', 'free', 'freemium', 'wcag', 'accessibility'],
            href: 'route/auditoria',
          },
          {
            id: 'auditoria-consultoria',
          ...
          },
          {
            id: 'auditoria-proceso',
            category: 'auditorias',
            title: 'Regulatory auth flows',
            hint: '3 documented flows with error states — UX evidence.',
            keywords: ['auth', 'regulatory', 'compliance', 'flows', 'process'],
            href: 'process/ux-ui-design',
          },
        ],
        panels: {
