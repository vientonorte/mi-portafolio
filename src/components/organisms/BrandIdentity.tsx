...
const copy = {
  es: {
    ...
    dos: [
      "Isologo RG con plato mate en dock liquid (legible, no monograma naranja sobre naranja)",
      "Wordmark «Rodrigo Gaete · UX Lead» en contextos editoriales",
      "Logos de cliente en wordmark-sm + flat sobre cards matte",
      "Gradiente solo en CTAs, acento del isologo y highlights clave (~10%)",
    ],
    donts: [
      "No repetir gradiente en fondos de card o iconografía masiva",
      "No Lucide + isologo + label decorativo en el mismo CTA del dock",
  ...
  en: {
    ...
    dos: [
      "RG mark with matte plate on liquid dock (readable, not orange-on-orange monogram)",
      "«Rodrigo Gaete · UX Lead» wordmark in editorial contexts",
      "Client logos as wordmark-sm + flat on matte cards",
      "Gradient only on CTAs, mark accent, and key highlights (~10%)",
    ],
    donts: [
