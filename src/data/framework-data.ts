...
export const frameworkPhases: FrameworkPhase[] = [
  {
    ...
    methods: [
      {
        name: "Análisis de Datos Cuantitativos",
        nameEN: "Quantitative Data Analysis",
        description: "Revisión de métricas de producto: tasas de conversión, abandono, tiempo en página, flujos de navegación críticos.",
        descriptionEN: "Product metrics review: conversion rates, abandonment, time on page, critical navigation flows.",
      },
      {
        name: "Heatmaps & Session Recordings",
        nameEN: "Heatmaps & Session Recordings",
        description: "Análisis de comportamiento visual: dónde hacen clic, cómo navegan, qué ignoran los usuarios.",
        descriptionEN: "Visual behavior analysis: where users click, how they navigate, what they ignore.",
      },
      {
        name: "Funnel Analysis",
        nameEN: "Funnel Analysis",
        description: "Identificación de puntos de fricción en flujos críticos de conversión.",
        descriptionEN: "Identifying friction points in critical conversion flows.",
      },
      {
        name: "A/B Testing Setup",
        nameEN: "A/B Testing Setup",
        description: "Preparación de experimentos para validar hipótesis de mejora.",
        descriptionEN: "Experiment preparation to validate improvement hypotheses.",
      },
    ],
    tools: ["Google Analytics", "Hotjar", "Mixpanel", "Amplitude", "Heap", "Looker"],
    deliverables: [
