...
export default {
    ...
    nav: {
      ...
      consultingDock: 'Consulting',
      consultingDockAria: 'Viento Norte consulting',
    ...
    consultoria: {
      ...
      landing: {
        ...
        description:
          'Diagnostic, prototype, team process, or digital tools on your perimeter.',
        transparencyLine:
          'Free: WCAG 2.2 AA of one flow (1-min form → report → call ≥48 h). Paid Diagnostic is a custom heuristic — not the same report.',
        ctaPrimary: 'Start',
        ctaSecondary: 'See options',
        /** Free a11y — form first; Calendar after submit */
        ctaFreeLink: 'Free WCAG review of one flow',
        ctaFreeLinkSchedule: 'After the form: book ≥48 h out',
        ctaFree: 'Request free review',
        trustLine: 'Reply within 24 h',
        trustChips: ['1-min form', 'WCAG report', 'Call ≥48 h'],
        ...
        segments: {
          ...
          app: {
            title: 'Digital tools',
            hint: 'Manual process → on your devices',
            cta: 'Talk about the tool',
          },
        },
      ...
      n2n: {
        ...
        description:
          'Five steps: understand, explore, test, prototype, and hand off. If the deliverable is a digital tool, VN is the counterpart; the build is a partner network or an MVP on your perimeter.',
      ...
      packagesSection: {
        ...
        freeStripBadge: 'Free · WCAG 2.2 AA · one flow',
        freeStripTitle: 'Free review of one critical flow',
        freeStripBody:
          'Site, name, phone, and email. We prepare the WCAG AA report (not the paid heuristic Diagnostic). On the call we walk it through and, if it fits, digital tools on your perimeter (your data + process monitoring).',
        freeStripCta: 'Request free review',
        freeStripCtaSchedule: 'Book the call (≥48 h)',
        freeStripCtaMessage: 'Start with the form',
        freeStripAfterForm:
          'Calendar opens after you send the form. Pick a slot ≥48 h out so the report is ready.',
        freeStripSecondary: 'Heuristic diagnostic (5–7 days)',
        appStripTitle: 'Digital tools',
        appStripBody:
          'Manual processes → a tool on your devices. Compliance (WCAG, Chile Act 21.719 — honest, not a legal opinion) and business monitoring. VN is the counterpart; the build is a partner network or a Worker/MCP MVP.',
        appStripCta: 'Talk about the tool',
      },
      educationPartner: {
        badge: 'Education',
      ...
      welcome: {
        ...
        points: [
          'Diagnostic · Prototype · Process · Digital tools',
          'Tool on your perimeter: VN counterpart; build with a network or MVP',
    ...
    contact: {
      ...
      form: {
        ...
        errors: {
          ...
          websiteRequired: 'The site to review is required',
          websiteInvalid: 'Enter a URL or domain (e.g. https://your-company.com)',
          phoneRequired: 'Phone is required',
          phoneMin: 'Enter a phone number with at least 8 digits',
