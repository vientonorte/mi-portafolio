...
`/servicios/seguridad-privacidad-digital/` es ficha Ley 21.719, no el tour X|CMS. POC Apple = `/#/consultoria`. Teaser dashboard solo en fichas producto (UX/IA). Tokens SPA (Chillax, hero `#0A0A0A`, CTA degradé) + CSS `/servicios/share.css`.
