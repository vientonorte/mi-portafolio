...
export default {
    ...
    consultoria: {
      ...
      landing: {
        ...
        description:
          'Diagnóstico, prototipo, proceso de equipo o herramientas digitales en tu perímetro.',
        transparencyLine:
          'Gratis: WCAG 2.2 AA de un flujo (formulario 1 min → informe → cita ≥48 h). El Diagnóstico pago es heurístico a medida, no el mismo informe.',
        ctaPrimary: 'Empezar',
        ctaSecondary: 'Ver opciones',
        /** Free a11y — form primero; Calendar después del envío */
        ctaFreeLink: 'Revisión gratis WCAG de un flujo',
        ctaFreeLinkSchedule: 'Después del form: agenda ≥48 h',
        ctaFree: 'Pedir revisión gratis',
        trustLine: 'Respuesta en menos de 24 h',
        trustChips: ['Form 1 min', 'Informe WCAG', 'Cita ≥48 h'],
        ...
        segments: {
          ...
          app: {
            ...
            hint: 'Proceso manual → en tus dispositivos',
            cta: 'Hablar de la herramienta',
          },
        },
      ...
      n2n: {
        ...
        description:
          'Cinco pasos: entender, explorar, probar, prototipar y entregar. Si el entregable es una herramienta digital, VN es el interlocutor; el build es red o un MVP en tu perímetro.',
      ...
      packagesSection: {
        ...
        freeStripBadge: 'Gratis · WCAG 2.2 AA · un flujo',
        freeStripTitle: 'Revisión gratis de un flujo crítico',
        freeStripBody:
          'Sitio, nombre, teléfono y correo. Armamos el informe WCAG AA (no es el Diagnóstico heurístico). En la cita lo recorremos y, si calza, herramientas digitales en tu perímetro (dato propio + monitoreo del proceso).',
        freeStripCta: 'Pedir revisión gratis',
        freeStripCtaSchedule: 'Agendar cita (≥48 h)',
        freeStripCtaMessage: 'Empezar por el formulario',
        freeStripAfterForm:
          'Calendar se abre después de enviar el form. Pedí un slot a ≥48 h para llegar con informe.',
        freeStripSecondary: 'Diagnóstico heurístico (5–7 días)',
        appStripTitle: 'Herramientas Digitales',
        appStripBody:
          'Procesos manuales → herramienta en tus dispositivos. Cumplimiento (WCAG, Ley 21.719 con honestidad) y monitoreo del negocio. VN interlocutor; el build es red o un MVP Worker/MCP.',
        appStripCta: 'Hablar de la herramienta',
      },
      educationPartner: {
        badge: 'Educación',
      ...
      welcome: {
        ...
        points: [
          'Diagnóstico · Prototipo · Proceso · Herramientas Digitales',
          'Herramienta en tu perímetro: VN interlocutor; build con red o MVP',
    ...
    contact: {
      ...
      form: {
        ...
        website: 'Sitio web a revisar',
        websitePlaceholder: 'https://tu-empresa.cl',
        phone: 'Teléfono',
        ...
        errors: {
          ...
          websiteRequired: 'El sitio a revisar es requerido',
          websiteInvalid: 'Ingresa una URL o dominio (ej. https://tu-empresa.cl)',
          phoneRequired: 'El teléfono es requerido',
          phoneMin: 'Ingresa un teléfono con al menos 8 dígitos',
